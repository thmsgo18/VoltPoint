 ...
 */
class getConnectorRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/ConnectorRepository.php';

        return $container->privates['App\\Repository\\ConnectorRepository'] = new \App\Repository\ConnectorRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
